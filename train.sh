...
if [ ${TMSPAN} = tag_mspan ]; then
  ...
  CACHED_TRAIN=${DATA_DIR}/tmspan_cached_albert_train.pkl
  CACHED_DEV=${DATA_DIR}/tmspan_cached_albert_dev.pkl
  ...
  CACHED_TRAIN=${DATA_DIR}/cached_albert_train.pkl
  CACHED_DEV=${DATA_DIR}/cached_albert_dev.pkl
...
BERT_CONFIG="--roberta_model ${DATA_DIR}/albert.large"
